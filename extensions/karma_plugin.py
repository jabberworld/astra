...
register_command_handler(karma_get, 'карма', ['karma', 'все'], 10, 'Посмотреть свою или чужую карму.', 'karm [user]', ['karm guy','karm'])
register_command_handler(karma_get_det, 'карма_детали', ['karma', 'все'], 10, 'Посмотреть статистическую свою или чужую карму.', 'karm [user]', ['karm guy','karm'])
