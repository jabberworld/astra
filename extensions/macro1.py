...
#										reply(type, source, u'вроде дала')
#										time.sleep(2)
...
def macrolist_handler11(type, source, Params):
        if source[1] in GROUPCHATS:
...
#register_command_handler(macrolist_handler, 'макролист+', [], 20, 'показывает список макро', '', [''])