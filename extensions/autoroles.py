...
def handler_amoder(type, source, body):
        if source[1] in GROUPCHATS:
                if body:
                        ...
                        if len(args) >= 2:
                                ...
                                if jid:
                                        ...
                                        repl = u'Если %s это ник, то таких юзеров я тут не видела, если же нет то ты просто хрень пишешь' % (nick)
                        else:
                                repl = u'инвалид синтакс'
                ...
                reply(type, source, u'Не понятно :(')
                ...
                if body:
                        ...
                        if len(args) >= 2:
                                ...
                                if jid:
                                        ...
                                        repl = u'Если %s это ник, то таких юзеров я тут невидела, если же нет то ты просто хрень пишеш' % (nick)
                        else:
                                repl = u'инвалид синтакс'
                        reply(type, source, repl)
                else:
