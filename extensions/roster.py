                                ...
                                if action == '+':
                                        ...
                                        if len(args) >= 3:
                                                ...
                                                if lx in [u'админ', 'admin']:
                                                        ...
                                                        reply(type, source, u'добавила в группу "ADMINS" с ником "%s"' % (args[2].strip()))
                                                else:
                                                        ...
                                                        reply(type, source, u'добавила в группу "USERS" с ником "%s"' % (args[2].strip()))
                                        else:
                                                RSTR['AUTH'].append(jid)
                                                if jid in RSTR['BAN']:
                                                        RSTR['BAN'].remove(jid)
                                                ...
                                                reply(type, source, u'добавила в группу "USERS"')
                                elif action == '-':
...
def roster_work(type, source, body):
        if body:
                ...
                if body in [u'вкл', 'on', '1']:
                        ...
                        reply(type, source, u'я непоняла чего ты хочеш')
        else:
                if RSTR['VN'] == 'on':
...
def Handler_Roster_IQ(stanza):
        ...
        if query and query.getNamespace() == xmpp.NS_ROSTER:
